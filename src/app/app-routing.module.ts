...
const routes: Routes = [
  ...
  // { path: 'saleskit', loadChildren: './saleskit/saleskit.module#SaleskitPageModule' },
  { path: 'homesaleskit', loadChildren: './saleskit/home/home.module#HomePageModule' },
  { path: 'saleskit', loadChildren: './saleskit/saleskit.module#SaleskitPageModule' },
  { path: 'ratecard', loadChildren: './ratecard/ratecard.module#RatecardPageModule' },
  ...
  { path: 'benefit', loadChildren: './benefit/benefit.module#BenefitPageModule' },
  ...
  { path: 'reimburse', loadChildren: './reimburse/reimburse.module#ReimbursePageModule' },
  { path: 'reportcam', loadChildren: './reportcam/reportcam.module#ReportcamPageModule' },
  { path: 'detailarticle', loadChildren: './detailarticle/detailarticle.module#DetailarticlePageModule' },
  ...
  { path: 'listam', loadChildren: './listam/listam.module#ListamPageModule' },
  { path: 'detailclient', loadChildren: './detailclient/detailclient.module#DetailclientPageModule' },
  { path: 'inputclient', loadChildren: './inputclient/inputclient.module#InputclientPageModule' },
  ...
  { path: 'companydet', loadChildren: './companydet/companydet.module#CompanydetPageModule' },
  { path: 'reportactivity', loadChildren: './reportactivity/reportactivity.module#ReportactivityPageModule' },
  // { path: '', loadChildren: './splash/splash.module#SplashPageModule' },
